...
sudo mysqldump -u 'root' -pswarna99@GB ecomdb > /home/lakshmiswarna041/mydb_backup.sql
* 0 * * * mysqldump -u 'root' -pswarna99@GB ecomdb > /home/lakshmiswarna041/mydb_backup.sql!/bin/bash
#firewall
sudo apt update
sudo apt install firewalld
sudo service firewalld start
...
#sub script to backup the mysql database directories, archive and backup
sudo mysqldump -u 'root' -pswarna99@GB ecomdb > /home/lakshmiswarna041/mydb_backup.sql
* 0 * * * mysqldump -u 'root' -pswarna99@GB ecomdb > /home/lakshmiswarna041/mydb_backup.sql
